...
const TONES = {
  certainty: { es: 'Certeza', tip: 'Sin dudar, afirma con confianza.', color: '#1E7A4C', emoji: '💪' },
  sincerity: { es: 'Sinceridad', tip: 'Cálido y genuino, sin presión de venta.', color: '#2E6F9E', emoji: '🤝' },
  reasonable: { es: 'El hombre razonable', tip: 'Calmado, justo, sin sonar defensivo.', color: '#6B6F76', emoji: '⚖️' },
  urgency: { es: 'Escasez / Urgencia', tip: 'Un dato objetivo, no agresivo.', color: '#C4571F', emoji: '⏳' },
  money_aside: { es: 'Dejar el dinero de lado', tip: 'Trátalo como un detalle secundario.', color: '#8A8763', emoji: '🙈' },
  ...
  mystery: { es: 'Misterio / Intriga', tip: 'Insinúa que hay más sin revelarlo todo.', color: '#3B3F4A', emoji: '🕵️' },
};
